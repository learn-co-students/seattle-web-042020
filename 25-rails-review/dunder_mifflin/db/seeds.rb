...
d1 = Dog.create(name: "Spot", breed: "Dalmatian", age: 7)
d2 = Dog.create(name: "Airbud", breed: "Golden Retriever", age: 5)
d3 = Dog.create(name: "Fido", breed: "Pomerian", age: 3)
Dog.create(name: "Snoopy", breed: "Mutt", age: 13)
Dog.create(name: "Juno", breed: "Mutt", age: 2)



e1 = Employee.create(first_name: "Jim", last_name: "Halpert", alias: "Big Tuna", title: "Regional Co-Manager", office: "Scranton", img_url: "https://s-i.huffpost.com/gen/2028878/images/n-UPROXX-628x314.jpg")
e2 = Employee.create(first_name: "Michael", last_name: "Scott", alias: "Prison Mike", title: "Regional Manager", office: "Scranton",  img_url: "https://i2.wp.com/mtncatholic.com/wp-content/uploads/2016/10/6357600113572837231773916132_michael-scott-s-top-tantrums.png?fit=500%2C359")
e3 = Employee.create(first_name: "Karen", last_name: "Filippelli", alias: "none", title: "Sales Representative", office: "Stamford",  img_url: "https://i.redd.it/vigerabg4x7z.jpg")
...
Show.create(employee_id: e1.id, dog_id: d1.id)
Show.create(employee_id: e2.id, dog_id: d2.id)
Show.create(employee_id: e3.id, dog_id: d3.id)
